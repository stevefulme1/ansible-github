"""Unit tests for stevefulme1.github.team module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.github.plugins.modules.team"
...
def resource_args(module_args):
    ...
    module_args.update({
        ...
        "organization_selection_type": None,
        "parent_team_id": None,
        "permission": None,
        "privacy": None,
        "repo_names": None,
...
class TestGetCurrentState:
    ...
    def test_returns_matching_resource(self, resource_args):
        ...
        from ansible_collections.stevefulme1.github.plugins.modules.team import get_current_state
...
class TestNeedsUpdate:
    ...
    def test_returns_true_when_no_current(self):
        ...
        from ansible_collections.stevefulme1.github.plugins.modules.team import needs_update
...
class TestBuildPayload:
    ...
    def test_builds_payload_from_params(self, resource_args):
        ...
        from ansible_collections.stevefulme1.github.plugins.modules.team import build_payload
...
class TestCreate:
    ...
    def test_create_sets_changed(self, mock_ansible_cls, mock_client_cls, resource_args):
        ...
        with patch(f"{MODULE_PATH}.get_current_state", return_value=None):
            from ansible_collections.stevefulme1.github.plugins.modules.team import main
            main()
