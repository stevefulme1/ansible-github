"""Unit tests for stevefulme1.github.environment_variable module."""
...
MODULE_PATH = "ansible_collections.stevefulme1.github.plugins.modules.environment_variable"
CLIENT_PATH = "ansible_collections.stevefulme1.github.plugins.module_utils.api_client"


def _build_resource(**overrides):
    """Return a mock environment_variable resource dict."""
    base = {
        "id": "res-123",
        "name": "test-name",
        "value": "test-value"
...
def resource_args(module_args):
    """Module args for environment_variable operations."""
    module_args.update({
        "state": "present",
...
class TestGetCurrentState:
    ...
    def test_returns_matching_resource(self, resource_args):
        ...
        from ansible_collections.stevefulme1.github.plugins.modules.environment_variable import get_current_state
...
class TestNeedsUpdate:
    ...
    def test_returns_true_when_no_current(self):
        ...
        from ansible_collections.stevefulme1.github.plugins.modules.environment_variable import needs_update
...
class TestBuildPayload:
    ...
    def test_builds_payload_from_params(self, resource_args):
        ...
        from ansible_collections.stevefulme1.github.plugins.modules.environment_variable import build_payload
...
class TestCreate:
    ...
    def test_create_sets_changed(self, mock_ansible_cls, mock_client_cls, resource_args):
        ...
        with patch(f"{MODULE_PATH}.get_current_state", return_value=None):
            from ansible_collections.stevefulme1.github.plugins.modules.environment_variable import main
            main()
...
class TestUpdate:
    ...
    def test_update_when_changed(self, mock_ansible_cls, mock_client_cls, resource_args):
        ...
        mock_client = MagicMock()
        mock_client.put.return_value = _build_resource(value="new-value")
        mock_client_cls.return_value = mock_client

        existing = _build_resource(value="old-value")
        with patch(f"{MODULE_PATH}.get_current_state", return_value=existing), \
